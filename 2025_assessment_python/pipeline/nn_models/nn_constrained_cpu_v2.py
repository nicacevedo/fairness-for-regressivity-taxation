...
class FeedForwardNNRegressorWithProjection:
    ...
    def __init__(self, categorical_features, output_size=1, batch_size=32, learning_rate=0.001, num_epochs=10, hidden_sizes=[50, 25], dev_thresh=0.15, random_state=None):
