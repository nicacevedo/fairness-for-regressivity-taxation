...
#         n_bins=500, binning_policy='uniform', max_diff_ratio=0.5,
...
if apply_resampling:
    resampler_emb = BalancingResampler( 
        n_bins=10, binning_policy='uniform', max_diff_ratio=0.1,
        undersample_policy='outlier', oversample_policy='smotenc',
        smote_k_neighbors=5, random_state=42,
...
resampler_emb.plot_distributions(sample_size=sample_size, kde=True)
exit()
        ...
        'hyperparameter': {
            ...
            'FeedForwardNNRegressorWithEmbeddings': {
                'range': {
                    ...
                    'hidden_sizes': [[1, 8], [16, 5000]],
                    # 'use_fourier_features':[True, False],
                    'patience':[8, 12], 
                    'loss_fn':['mse',  'huber'], #'focal_mse',
                    # 'n_bins' : [],
                    'gamma' : [1, 1.5],
                    # V3
                    'fourier_type' : ['basic', 'positional', 'gaussian'], # 'none', 
                    'fourier_mapping_size' : [25, 45],
                    'fourier_sigma' : [1, 5],
                    #v4
